...
export async function waveSvg({ title }: RenderFunctionInput): Promise<React.ReactNode> {
  return Promise.resolve(
    <div style={twj("h-full w-full flex items-start justify-start bg-yellow-50 relative")}>
      <h1 style={twj("text-[64px] p-20 font-bold text-left text-gray-900 m-0")}>{title}</h1>

      <svg style={twj("absolute bottom-0 left-0 right-0")} viewBox="0 0 1200 627" width="1200" height="627" xmlns="http://www.w3.org/2000/svg">
        <path
